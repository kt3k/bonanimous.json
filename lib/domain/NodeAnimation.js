...
var NodeAnimation = subclass(function (pt) {
    ...
    pt.keyframes = function () {
        ...
        keyframes = keyframes.concat(this.rotations.keyframes());
        keyframes = keyframes.concat(this.scalings.keyframes());
        keyframes = keyframes.concat(this.translations.keyframes());
